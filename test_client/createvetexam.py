...
# URL de l’endpoint
url = f'http://127.0.0.1:8000/api/vetexam/{animal_id}'
...
data = {
    ...
    "date_of_treatment": "2024-06-01",
    "medication": "Veterimax",
    "remarks": "VeterimaxVeterimax",
...
if response.status_code == 201:
    print("✅ Soins Vétérinaire enregistrée :", response.json())
else:
